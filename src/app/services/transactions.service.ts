...
function generateMockTransactionsData(mockData: any) {
...
export class TransactionsService {
  readonly transactions$: Observable<any> = interval(750).pipe(
    map(() =>
      generateMockTransactionsData([transactionsData, transactionsData1])
    )
  );
}
